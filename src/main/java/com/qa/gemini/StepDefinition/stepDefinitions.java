...
public class stepDefinitions {
    ...
    public void hitApiToken(String url, String url1, String url2, String url3, String method, String method1, String SampleName, String SampleName2) throws Exception {
        utils.TextUpload(url1, "Hello World", ProjectConfigData.getProperty("username"), Gettoken2());
    ...
    public void Suite_Api(String url, String method, String SampleName) throws Exception {
        status = utils.CheckAPiWithAuth(url, method, Gettoken2(), SampleName).getStatus(); //returns bridge token
    }
    ...
    public void Suite_Api2(String url, String method, String SampleName) throws Exception {
        status = utils.CheckAPiWithAuth(url, method, Gettoken2() + "maulick", SampleName).getStatus();
    }
    ...
    public void UpdateSuite3(String url, String method, String SampleName) throws Exception {
        status = utils.requestSuiteApi(url, method, Gettoken2() + "maulick", SampleName, "b2f779e7-a4f2-44d8-a557-b3426ea520c14").getStatus();
    }
    ...
    public void fileUpload(String url, String url1, String method, String SampleName) throws Exception {
        status = utils.FileUpload(url, "src/main/resources/Access_sampleJson.json", ProjectConfigData.getProperty("username"), Gettoken2());
        Map<String, String> headers = new HashMap<>();
        String username = ProjectConfigData.getProperty("username");
        String bt = Gettoken2();
        headers.put("username", username);
    ...
    public void fileUpload2(String url) throws Exception {
        status = utils.FileUpload(url, "src/main/resources/Access_sampleJson.json", ProjectConfigData.getProperty("username"), Gettoken2() + "maulick");
    }
    ...
    public void azureUpload(String url, String url1, String method, String SampleName) throws Exception {
        ...
        assert j != null;
        String jnew = j.replaceAll("^\"|\"$", "");
        status = utils.AzurefileUpload(url, "src/main/resources/Access_sampleJson.json", jnew);
        Map<String, String> headers = new HashMap<>();
        String username = ProjectConfigData.getProperty("username");
        String bt = Gettoken2();
        headers.put("username", username);
    ...
    public void fileUpload4(String url) throws Exception {
        status = utils.FileUpload(url, "src/main/resources/Access_sampleJson.json", "", Gettoken2());
    }
    ...
    public void fileUpload6(String url, String url1, String method, String SampleName) throws Exception {
        status = utils.TextUpload(url, "Hello World", ProjectConfigData.getProperty("username"), Gettoken2()).getStatus();
        Map<String, String> headers = new HashMap<>();
        String username = ProjectConfigData.getProperty("username");
        String bt = Gettoken2();
        headers.put("username", username);
    ...
    public void fileUpload7(String url) throws Exception {
        status = utils.TextUpload2(url, "Hello World", ProjectConfigData.getProperty("username"), Gettoken2()).getStatus();
    }

    @Given("^Set endpoint with text with wrong BridgeToken \"(.*)\"$")
    public void fileUpload8(String url) throws Exception {
        status = utils.TextUpload2(url, "Hello World", ProjectConfigData.getProperty("username"), Gettoken2() + "hello").getStatus();
    }
    ...
    public void fileUploads(String url) throws Exception {
        status = utils.TextUpload2(url, "Hello World", "abcdefghijk", Gettoken2()).getStatus();
    }
