...
#  Scenario Outline: File upload with s_run with url and user has access
#    Given Set posterr userrss wrong token endpoint and method "<endpoint>" and "<Method>"
#    Then Verify Status code <Expected_status>
#    Examples:
#      | endpoint        | Method | Expected_status |
#      | fileUploadCheck | get    | 200             |
